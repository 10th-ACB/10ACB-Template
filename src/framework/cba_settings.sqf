...
force force ace_advanced_fatigue_loadFactor = 5;
force force ace_advanced_fatigue_performanceFactor = 5;
force force ace_advanced_fatigue_recoveryFactor = 5;
force force ace_advanced_fatigue_terrainGradientFactor = 5;
...
force force ace_common_checkPBOsWhitelist = "[""achilles_data_f_ares"",""achilles_language_f"",""achilles_data_f_achilles"",""achilles_functions_f_ares"",""achilles_functions_f_achilles"",""achilles_modules_f_ares"",""achilles_modules_f_achilles"",""AchillesEffects"",""achilles_settings_f"",""achilles_ui_f"",""athena""]";
